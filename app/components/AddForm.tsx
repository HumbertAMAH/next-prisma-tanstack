...
export default function AddForm() {
  ...
  const mutation = useMutation({
    mutationFn: async (formData: FormData) => {
      // Fonction de mutation qui prend en entrée les données du formulaire
    ...
    onError: (error) => {
      // Fonction appelée en cas d'erreur de la mutation
  ...
  return (
    <form
      ...
      className="max-w-[1000px] flex items-center mb-2"
    >
      <input
